        ...
        <div class="grid grid-cols-2 gap-4">
          ...
          <div v-if="form.idType" class="col-span-2">
            ...
            <input v-if="form.idType === 'thai_id'" v-model="form.idCard" type="text" inputmode="numeric"
              ...
              @input="checkDuplicateIdCard(form.idCard)" />
          ...
          <div v-for="exp in sortedExpenses" :key="exp.exp_id"
            ...
            <div v-else class="flex items-center gap-3">
              ...
              <input v-if="form.expenseOrders[exp.exp_id]?.size?.startsWith('พิเศษ')"
                v-model="form.expenseOrders[exp.exp_id].customSize" type="text" placeholder="ระบุขนาดรอบอกเป็นนิ้ว "
                class="input-field !w-48 !py-1.5 text-xs" />
