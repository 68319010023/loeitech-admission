<template>
    ...
    <table class="w-full text-sm">
      ...
      <tbody class="divide-y divide-gray-50">
        ...
        <tr v-if="data.length === 0">
          <td colspan="5" class="px-4 py-8 text-center text-gray-400">ไม่พบข้อมูล</td>
        </tr>
      </tbody>
    </table>
  </div>
  ...
  <Teleport to="body">
    <div
      ...
      <div class="bg-white rounded-2xl shadow-2xl w-full max-w-3xl mx-4 overflow-hidden flex flex-col" style="max-height: 90vh">
        ...
        <div class="flex flex-1 overflow-hidden">
          ...
          <div class="w-36 flex-shrink-0 border-r border-gray-100 overflow-y-auto bg-gray-50">
            <button
              v-for="doc in docModal.documents"
              :key="doc.doc_type"
          ...
          <div class="flex-1 flex items-center justify-center bg-gray-50 p-4 overflow-auto">
            ...
            <template v-else-if="blobUrl && !docModal.imgError">
              <img
                :src="blobUrl"
                class="max-w-full max-h-full rounded-xl object-contain shadow-md"
                style="max-height: 60vh"
                @error="docModal.imgError = true" />
            </template>
