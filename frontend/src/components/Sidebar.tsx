...
const Sidebar = () => {
  ...
  const menuItems = [
    { icon: FileText, label: t('fillApplication'), active: true },
    { icon: CheckCircle, label: t('checkStatus'), active: false },
  ];

  const adminItems = [
    { icon: Users, label: t('manageUsers'), active: false },
    { icon: Settings, label: t('systemSettings'), active: false },
  ];
